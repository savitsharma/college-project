...
class student:
    ...
    # first image 
        ...
        img3=Image.open(r"C:\Users\HP\Desktop\final year project\images\student_2.png")
    ...
    #  bg image
        ...
        current_course_frame.place(x=5,y=135,width=750,height=110)
        ...
        dep_combo["values"]=("select deapartment","CSE","IT","EC","CIVIL","MECHANICAL")
        dep_combo.current(0)
        ...
        studentid_entry=ttk.Entry(class_student_frame, textvariable=self.var_std_id,width=21,font=("times new roman",12,"bold"))
        ...
        studentname_entry=ttk.Entry(class_student_frame, textvariable=self.var_std_name ,width=21,font=("times new roman",12,"bold"))
        ...
        div_combo=ttk.Combobox(class_student_frame, textvariable=self.var_div,font=("times new roman",12,"bold"),width=19,state="read only")
        ...
        rollno_entry=ttk.Entry(class_student_frame, textvariable=self.var_roll ,width=21,font=("times new roman",12,"bold"))
        ...
        gender_combo=ttk.Combobox(class_student_frame, textvariable=self.var_gender,font=("times new roman",12,"bold"),width=19,state="read only")
        ...
        dob_entry=ttk.Entry(class_student_frame, textvariable=self.var_dob,width=21,font=("times new roman",12,"bold"))
        ...
        email_entry=ttk.Entry(class_student_frame, textvariable=self.var_email ,width=21,font=("times new roman",12,"bold"))
        ...
        phoneno_entry=ttk.Entry(class_student_frame, textvariable=self.var_phone ,width=21,font=("times new roman",12,"bold"))
        ...
        address_entry=ttk.Entry(class_student_frame, textvariable=self.var_address ,width=21,font=("times new roman",12,"bold"))
        address_entry.grid(row=4,column=1,padx=10,pady=5, sticky=W)


        # teacher name

        teacher_label=Label(class_student_frame,text="Tearcher Name:",font=("times new roman",12,"bold"),bg="white")
        teacher_label.grid(row=4,column=2,padx=10,pady=5, sticky=W)

        classdiv_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher, width=21,font=("times new roman",12,"bold"))
        classdiv_entry.grid(row=4,column=3,padx=10,pady=5, sticky=W)
        ...
        btn_frame1.place(x=0,y=235,width=745,height=40)

        take_photo_btn=Button(btn_frame1,text="Take a photo sample",command=self.generate_dataset,width=40,font=("times new roman",12,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,text="update photo",width=40,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\HP\Desktop\final year project\images\student_4.png")
        img_right=img_right.resize((755,130),Image.ANTIALIAS)
        ...
        search_frame.place(x=5,y=138,width=690,height=70)

        #  search by

        searchby_label=Label(search_frame,text="Search By:",font=("times new roman",15,"bold"),bg="olive",fg="white")
        ...
        table_frame.place(x=5,y=210,width=690,height=342)
        ...
        if self.var_dep.get()=="select department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="Pranjal@123", database="face_recognization",auth_plugin="mysql_native_password")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update students set department=%s, course=%s, year=%s, semester=%s, Name=%s, Division=%s, Roll_no=%s, Gender=%s, DOB=%s, Email=%s, Phone=%s, Address=%s, Teacher=%s, Photo_Sample=%s where student_id=%s",(
                    ...
                    if not update:
                        return
                messagebox.showinfo("SUCCESS","students detais succesfully updated",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="select department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            # except:
                ...
                face_classifier=cv2.CascadeClassifier("haarcascade_frontalface_default.xml")          # object detection
