...
class Register:
    def __init__(self, root):
     ...
     #----variable---
        ...
        self.bg=ImageTk.PhotoImagefile=("C:\Users\Admin\Desktop\login_form\images")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,width=1,height=1)
...
# ==============main Frame=====================
        ...
        self.txt_contact.place(x=370,y=130,width=250)
        ...
        self.combo_securiy_Q.currente(0)
        ...
        self.txt_confirm_pswdattk. Entry(frame,variable=self.var_confpass, font=("times new roman",15)) 
        self.txt_confirm_pswd.place(x=370, y=340,width=250)

        #      ===================checkbutton=‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
     
        self.var_check=intvar()
        self.checkbtn=Checkbutton(frame,textvariable=self.var_check, text="I Agree The Terms & Conditions", font=("times new roman",12,"bold"),onvalue=1,offvalue=0
        self.checkbtn.place(x=50,y=380)

        # =================buttons=======‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒

        img=Image.open(r"C:\Users\Admin\Desktop\login_form\images\register-now-button1.jpg")
        ...
        img1=Image.open(r"C:\Users\Admin\Desktop\login_form\images\loginpng.png")
    ...
    def register_data(self):
        if self.var_fname.get()=="" or self.var_email.get()=="" or self.var_securityQ.get()=="Select": 
            ...
            query=("select from register where email-Xs")
